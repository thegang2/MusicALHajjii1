...
async def restart(client, m: Message):
    await m.delete()
    TeamALHajji = await m.reply("1")
    await TeamALHajji.edit("2")
    await TeamALHajji.edit("3")
    await TeamALHajji.edit("4")
    await TeamALHajji.edit("5")
    await TeamALHajji.edit("6")
    await TeamALHajji.edit("7")
    await TeamALHajji.edit("8")
    await TeamALHajji.edit("9")
    await TeamALHajji.edit("**تم اعادة تشغيل سورس ابن الدورة ميوزك بنجاح ✓**")
